...
SECRET_KEY = 'django-insecure-&=tovgvhi9vr6$4g3+v!fd707+9)ibgf!=39r%izxa5)q251+d'
...
INSTALLED_APPS = [
    ...
    'inventory_app',  # Custom app for inventory management
]
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = 'dashboard'  # or another appropriate name/path

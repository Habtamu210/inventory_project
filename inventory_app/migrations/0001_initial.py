# Generated by Django 5.2.3 on 2025-07-12 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('EMPLOYEE', 'Employee'), ('DIRECTOR', 'Director'), ('INVENTORY_OFFICER', 'Inventory Officer')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING_DIRECTOR', 'Pending Director Approval'), ('REJECTED_DIRECTOR', 'Rejected by Director'), ('PENDING_OFFICER', 'Pending Inventory Officer Approval'), ('REJECTED_OFFICER', 'Rejected by Inventory Officer'), ('APPROVED', 'Approved')], default='PENDING_DIRECTOR', max_length=30)),
